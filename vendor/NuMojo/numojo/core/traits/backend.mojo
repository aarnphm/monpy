...
trait Backend(ImplicitlyDestructible):
    ...
    def math_func_1_array_in_one_array_out[
        dtype: DType,
        func: def[simd_w: Int](SIMD[dtype, simd_w]) capturing -> SIMD[dtype, simd_w],
    ...
    def math_func_is[
        dtype: DType,
        func: def[simd_w: Int](SIMD[dtype, simd_w]) capturing -> SIMD[
            DType.bool, simd_w
        ],
    ...
    #     dtype: DType,
    #     func: def[simd_w: Int] (SIMD[dtype, simd_w], Int) -> SIMD[
    #         type, simd_w
    #     ],

...
def quick_sort_1d[dtype: DType](a: NDArray[dtype]) capturing raises -> NDArray[dtype]:
    """
...
def quick_sort_stable_inplace_1d[dtype: DType](mut a: NDArray[dtype]) capturing raises:
    """
    Sort array in-place using quick sort method.
    Regardless of the shape of input, it is treated as a 1-d array.
    The sorting is stable.

...
def _compute_householder[
    ...
    vectorize[simd_width, load_store_vec](rRows - work_index)
    ...
    vectorize[simd_width, calculate_norm](rRows)
    ...
    vectorize[simd_width, scaling_factor_vec](rRows)
    ...
    vectorize[simd_width, scaling_factor_increment_vec](rRows)
...
def _apply_householder[
    ...
    for j in range(column_start, aCols):
        ...
        vectorize[simdwidth, calculate_norm](aRows)
        ...
        vectorize[simdwidth, closure](aRows)

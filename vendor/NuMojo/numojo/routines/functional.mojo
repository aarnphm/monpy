...
#     dtype: DType,
#     func1d: def[dtype_func: DType](NDArray[dtype_func]) capturing raises -> Scalar[
#         dtype_func
#     ],
...
def apply_along_axis_preserve[
    dtype: DType,
    func1d: def[dtype_func: DType](NDArray[dtype_func]) capturing raises -> NDArray[
        dtype_func
    ],
](a: NDArray[dtype], axis: Int) raises -> NDArray[dtype]:
    """
...
def apply_along_axis_inplace[
    dtype: DType,
    func1d: def[dtype_func: DType](mut NDArray[dtype_func]) capturing raises -> None,

...
def build_cases(
  *,
  ...
  z64_mp: Any = mnp.asarray(z64_np, dtype=mnp.complex64, copy=True)
  w64_mp: Any = mnp.asarray(w64_np, dtype=mnp.complex64, copy=True)
  z128_mp: Any = mnp.asarray(z128_np, dtype=mnp.complex128, copy=True)
  w128_mp: Any = mnp.asarray(w128_np, dtype=mnp.complex128, copy=True)
  ...
  lhs64_mp: Any = mnp.asarray(lhs64_np, dtype=mnp.complex64, copy=True)
  rhs64_mp: Any = mnp.asarray(rhs64_np, dtype=mnp.complex64, copy=True)
